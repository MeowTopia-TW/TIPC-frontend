   ...
   <div className="grid grid-cols-4 gap-4 w-full">
      {filters.map((filter) => (
        <Button 
          ...
          className={`flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 transition-all duration-200 ${
